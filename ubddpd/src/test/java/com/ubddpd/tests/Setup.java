...
public class Setup {
	...
	public Setup() throws IOException {
		...
		String configFileContents = getFileContentsAsString("./res/conf/test_config.json");
		testConfig = mapper.readValue(configFileContents, new TypeReference<Map<String, Object>>() {
		});
		PageFactory.initElements(driver, this); //Needed to use FindBy annotations
	}
